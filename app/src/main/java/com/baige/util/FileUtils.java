...
public class FileUtils {
     ...
     * @return
     */
    public static boolean contansPath(List<FileInfo> infos, String path) {
        boolean isIn = false;
     ...
     * @return
     */
    public static int getPositionInFileList(List<FileInfo> infos, String path) {
    ...
    public static void selecteAll(List<FileInfo> infos, boolean checked) {
        for (FileInfo simpleFileInfo : infos) {
     ...
     * @return
     */
    public int findPostion(List<FileInfo> fileInfos, String path) {
        for (int i = 0; i < fileInfos.size(); i++) {
            if (fileInfos.get(i).getPath().endsWith(path)) {
                return i;
            }
        }
        return 0;
    ...
    public static String getAppNameFromMap(String name) {
        ...
        String appName = CacheRepository.mAppNameMap.get(name);
