...
public class FileListBottomOperatorMenu extends LinearLayout implements OnClickListener {
    ...
    public void show() {
        isShow = true;
        mRootView.scrollTo(0, -BitmapTools.dp2px(getContext(), 45 * 4 + 6));
        isShowMore = false;
        postInvalidate();
    }
    ...
    public boolean hasSelecteAll(List<FileInfo> infos, List<String> checks) {
    ...
    public interface OnMenuItemClickListener {
         void onItemClick(View rootView, View view);
         void onSelecteAll(View view, boolean selecteAll);
    }
